CREATE TABLE IF NOT EXISTS swipes (
  ...
  FOREIGN KEY (meeting_name, sec_name, stu_ci_term, stu_ci_name, stu_ci_year) REFERENCES section_meetings (m_name, s_name, ci_term, ci_name, ci_year) ON DELETE CASCADE
);
